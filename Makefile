...
INCDIRS 	= include $(LIB_VLIBDIR)/include
...
LIBS_RELEASE	= $(SUBLIBS) $(sys_LIBS) $(CONFIG_ZLIB) -lm -lpthread
MACROS_RELEASE	=
...
CHECK_RUN	= echo "libvsensors tests are in https://github.com/vsallaberry/vsensorsdemo"
